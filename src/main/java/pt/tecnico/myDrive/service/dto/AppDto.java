...
public class AppDto extends PlainFileDto{
     ...
     */
    public AppDto(int id, String name, DateTime modified, short umask, String parent, String owner, String content, String representation){
